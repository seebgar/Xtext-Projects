...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Tamano Servidor</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see ceffective.CeffectivePackage#getTamanoServidor()
 * @model
 * @generated
 */
public enum TamanoServidor implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Tamano Servidor</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TamanoServidor[] VALUES_ARRAY =
		new TamanoServidor[] {
			MICRO,
			SMALL,
			MEDIUM,
	...
	/**
	 * A public read-only list of all the '<em><b>Tamano Servidor</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TamanoServidor> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static TamanoServidor get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TamanoServidor result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private TamanoServidor(int value, String name, String literal) {
		this.value = value;
		this.name = name;
